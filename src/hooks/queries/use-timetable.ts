...
export type TimetableInput = Pick<TimetableEntry, 'centerId' | 'activityId' | 'dayOfWeek' | 'startTime' | 'endTime'> & Partial<Pick<TimetableEntry, 'classLevelId' | 'teacherIds' | 'room' | 'notes'>>;
