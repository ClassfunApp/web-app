...
export function StatCard({
  ...
  return (
    <div className={cn(
      'bg-white rounded-2xl border border-slate-100 shadow-[0_2px_8px_0_rgba(0,0,0,0.04)] p-5',
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="mt-1 text-[28px] font-bold text-slate-800 leading-none tracking-tight animate-count-up">
            {value}
          </p>
...
export function StatCardSkeleton() {
  return (
    <div className="bg-white rounded-2xl border border-slate-100 shadow-[0_2px_8px_0_rgba(0,0,0,0.04)] p-5">
      <div className="flex items-start gap-4">
