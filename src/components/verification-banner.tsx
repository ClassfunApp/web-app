...
export function VerificationBanner() {
  ...
  return (
    <div className={`flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3 rounded-lg border px-3 sm:px-4 py-3 ${bg}`}>
      ...
      <Link
        to="/verification"
        className={`flex items-center justify-center gap-1 text-xs sm:text-sm font-medium whitespace-nowrap ${text} hover:underline bg-white/50 dark:bg-slate-900/50 sm:bg-transparent rounded-md px-3 py-1.5 sm:px-0 sm:py-0`}
      >
